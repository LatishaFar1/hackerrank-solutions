...
def countingsort(arr):
    #we need to return a frequency array with 100 elements 
    #initialize count and make it equal to a list of zeroes * 100 elements
    count = [0] * 100
    #loop through the element in the array
    for i in arr:
    #add 1 to the count of each element 
        count[i] += 1
    #return count
    return count